...
func (t *Text) DrawTimeline() app.Component {
	return func(rect rl.Rectangle) (func(), float32, float32) {
		...
		if fontSizeComponent.CanDrawTimeline() {
			layout.Add(components.TimelineRow("Font size", fontSizeComponent.Input(), t.FontSize))
		}

		colorComponent := components.NewAnimatedColor(&t.Color, t, prefix)
		if colorComponent.CanDrawTimeline() {
			layout.Add(components.TimelineRow("Color", colorComponent.Input(), t.Color.Red))
		}
